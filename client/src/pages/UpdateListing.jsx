  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (formData.imageUrls < 1)
        return setErrorCreating("You must be upload at least one image.");
      if (+formData.regularPrice < +formData.discountPrice)
        return setErrorCreating(
          "Discount Price must be less than Regular Price."
        ); //we can use "+" sign  change to number
  ...
  return (
    <div className="p-3 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-3 ">
                  ...
                  return (
                    ...
                    >
                      ...
                      <button
                        ...
                        type="button"
                        className="text-red-700 rounded-md p-3"
                      >
                        Delete
                      </button>
                    </div>
        ...
        >
          {loadCreating ? "Updating..." : "Update Listing"}
        </button>
